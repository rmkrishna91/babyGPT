...
block_size = 8#context length or time
max_iters = 3000
eval_interval = 300
learning_rate = 1e-2
...
#all the unique character in the data
chars = sorted(list(set(text)))
vocab_size = len(chars)

#creating encoder and decoder for tokenization and detokenization
